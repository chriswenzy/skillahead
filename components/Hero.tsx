...
export default function Hero() {
  return (
    <header className="relative min-h-[85vh] flex items-center bg-[#fcfcfd] overflow-hidden pt-20">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 w-full py-12 lg:py-0 relative z-10">
        <div className="grid grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-6 animate-fade-in">
            ...
            {/* Trust Badge */}
            <div className="mt-16 flex flex-wrap items-center gap-10 border-t pt-10 border-slate-200">
              <div className="flex flex-col">
                <p className="text-3xl font-black text-slate-900 tracking-tighter">98%</p>
                <p className="text-[10px] uppercase text-slate-400 font-bold tracking-[0.2em] mt-1">Placement Rate</p>
              </div>
              <div className="flex flex-col">
                <p className="text-3xl font-black text-slate-900 tracking-tighter">200+</p>
                <p className="text-[10px] uppercase text-slate-400 font-bold tracking-[0.2em] mt-1">Partners</p>
              </div>
              <div className="flex -space-x-3 items-center">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full border-2 border-white bg-slate-200 flex items-center justify-center text-[10px] font-black text-slate-600 shadow-sm uppercase">AD</div>
                ))}
              </div>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-6 relative mt-16 lg:mt-0 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="relative w-full aspect-square max-w-[580px] ml-auto">
              {/* Main visual content */}
              <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl bg-white border border-slate-100">
                <Image 
