    ...
    <section className="py-24 bg-primary text-white">
      <div className="max-w-[1440px] mx-auto px-8 md:px-16">
        <div className="mb-20 text-center">
          ...
          <h2 className="text-4xl font-black text-white">Learn from Authority</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          {/* Mentor 1 */}
          <div className="flex flex-col sm:flex-row gap-8 items-start group">
            <div className="w-full sm:w-48 h-64 bg-slate-800 rounded relative overflow-hidden flex-shrink-0">
          ...
          {/* Mentor 2 */}
          <div className="flex flex-col sm:flex-row gap-8 items-start group sm:mt-16">
            <div className="w-full sm:w-48 h-64 bg-slate-800 rounded relative overflow-hidden flex-shrink-0">
               <div className="w-full h-full flex items-center justify-center text-5xl opacity-20">👤</div>
            </div>
            <div className="space-y-4">
