        ...
        <div className="bg-gradient-to-br from-primary to-primary-deep rounded-[2rem] overflow-hidden relative shadow-2xl group min-h-[350px] md:min-h-[400px] flex items-center justify-center">
          ...
          <div className="relative z-10 px-8 py-16 md:px-12 md:py-24 text-center max-w-3xl mx-auto space-y-8 md:space-y-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 pt-4">
              <button className="bg-white text-[#001844] w-full sm:w-auto px-12 py-5 rounded font-black uppercase tracking-widest text-xs hover:shadow-2xl transition-all">Start Application</button>
              <button className="border-2 border-white text-white w-full sm:w-auto px-12 py-5 rounded font-black uppercase tracking-widest text-xs hover:bg-white/10 transition-colors">Download Brochure</button>
            </div>
          </div>
        </div>
      </div>
