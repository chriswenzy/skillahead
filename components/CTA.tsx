  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-[1440px] mx-auto px-16">
        <div className="bg-primary rounded-[2rem] overflow-hidden relative shadow-2xl group min-h-[400px] flex items-center justify-center">
          ...
          <div className="relative z-10 px-12 py-24 text-center max-w-3xl mx-auto space-y-12">
            ...
            <p className="text-lg text-blue-100/90 font-medium max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <button className="bg-white text-primary px-12 py-5 rounded font-black uppercase tracking-widest text-xs hover:shadow-2xl transition-all">Start Application</button>
