    ...
    <section className="py-16 md:py-24 bg-slate-50 overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 text-center mb-12 md:mb-16">
        <ScrollReveal>
          ...
          <h2 className="text-[clamp(26px,8vw,48px)] font-black text-slate-900 tracking-tight">Choose Your Path</h2>
        </ScrollReveal>
      </div>
      
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-8">
        {/* School of Data */}
        <ScrollReveal direction="right" delay={0.1}>
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100 group flex flex-col justify-between hover:shadow-2xl transition-all min-h-[320px] md:h-[400px]">
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="text-sm md:text-slate-600 font-medium leading-relaxed max-w-sm break-words whitespace-normal mx-auto md:mx-0">
        ...
        <ScrollReveal direction="left" delay={0.2}>
          <div className="bg-primary-deep rounded-3xl p-8 md:p-12 shadow-2xl text-white group flex flex-col justify-between hover:shadow-[0_0_50px_rgba(0,22,61,0.3)] transition-all min-h-[320px] md:h-[400px]">
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="text-sm md:text-white/80 font-medium leading-relaxed max-w-sm break-words whitespace-normal mx-auto md:mx-0">
