  ...
  return (
    <section className="py-16 md:py-24 bg-surface overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 md:px-16">
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-y-8 lg:gap-8 items-end mb-12 md:mb-20">
          <div className="w-full lg:col-span-6">
            <h2 className="text-[clamp(24px,6vw,28px)] font-black text-primary mb-4 tracking-tight uppercase">World-Class Specializations</h2>
            <p className="text-slate-500 font-medium max-w-md text-[10px] md:text-xs leading-relaxed uppercase tracking-widest opacity-80 break-words whitespace-normal">Our curriculum is designed by practitioners from Silicon Valley and Lagos to meet the exacting standards of modern tech stacks.</p>
          </div>
          <div className="w-full lg:col-span-6 hidden sm:flex lg:justify-end">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-6 md:gap-8">
          {/* Featured Track */}
          <div className="w-full lg:col-span-8 group relative overflow-hidden rounded-[2.5rem] bg-primary text-white p-8 md:p-16 shadow-2xl min-h-[400px] md:min-h-[500px] flex flex-col justify-end border border-white/10">
            <div className="absolute top-0 right-0 md:top-10 md:right-10 p-8 md:p-16 opacity-10">
               <span className="text-[80px] md:text-[140px] leading-none">💾</span>
            </div>
          ...
          {/* Secondary Tracks */}
          <div className="w-full lg:col-span-4 flex flex-col gap-6 md:gap-8">
