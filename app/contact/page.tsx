    ...
    <main className="bg-white min-h-screen pt-40 pb-24">
      <div className="max-w-[1440px] mx-auto px-8 md:px-16">
        ...
        <div className="grid grid-cols-12 gap-16">
          {/* Contact Form */}
          <div className="col-span-12 lg:col-span-7 bg-slate-50 p-12 lg:p-20 rounded-[3rem]">
               ...
               <div className="space-y-8">
                 ...
                 <div className="grid grid-cols-1 gap-6">
                   <div className="border-l-2 border-slate-100 pl-6 py-2">
                     <p className="font-black text-slate-900 text-sm">Port Harcourt</p>
                     <p className="text-xs text-slate-500 font-medium">8 Old Aba Road, Nma Plaza</p>
                   </div>
                   <div className="border-l-2 border-slate-100 pl-6 py-2">
                     <p className="font-black text-slate-900 text-sm">Lagos</p>
                     <p className="text-xs text-slate-500 font-medium">6 Ashabi Cole Street, Ikeja</p>
                   </div>
                   <div className="border-l-2 border-slate-100 pl-6 py-2">
                     <p className="font-black text-slate-900 text-sm">Abuja</p>
                     <p className="text-xs text-slate-500 font-medium">16 Gwani Street, Wuse Zone 4</p>
                   </div>
                 </div>
               </div>
